  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColors: { value: buildPalette(currentProps.colors) },
        uColorCount: { value: Math.min(currentProps.colors.length, MAX_COLORS) },
        uStrandCount: { value: Math.min(currentProps.count, MAX_STRANDS) },
        uSpeed: { value: currentProps.speed },
        uAmplitude: { value: currentProps.amplitude },
        uWaviness: { value: currentProps.waviness },
        uThickness: { value: currentProps.thickness },
        uGlow: { value: currentProps.glow },
        uTaper: { value: currentProps.taper },
        uSpread: { value: currentProps.spread },
        uHueShift: { value: currentProps.hueShift },
        uIntensity: { value: currentProps.intensity },
        uOpacity: { value: currentProps.opacity },
        uScale: { value: currentProps.scale },
        uSaturation: { value: currentProps.saturation },
      },
    });
    ...
    const glassProgram = new Program(gl, {
      ...
      uniforms: {
        ...
        uResolution: { value: [container.offsetWidth, container.offsetHeight] },
        uRadius: { value: 0.46 * currentProps.glassSize },
        uRefraction: { value: currentProps.refraction },
        uDispersion: { value: currentProps.dispersion },
      },
    });
